 ...
 *
 * <p>This class provides methods to retrieve relevant questions for users based on their type and
 * session.
 *
...
public class QuestionService {
   ...
   * @throws SessionNotFoundException if the session ID is invalid
   * @throws UserNotFoundException if the user ID is invalid
   * @throws InvalidOperationException if the user is not a participant in the session or if the
